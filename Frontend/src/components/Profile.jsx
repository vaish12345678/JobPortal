...
//     console.log("🔍 Full user data:", user); // DEBUG
    
//     // FIX: Correct data structure according to your schema
//     setProfileData({
//       _id: user._id,
//       name: user.fullname,
...
//       skills: user.profile?.skills ? user.profile.skills.join(",") : "", // ← skills inside profile
//       resume: user.profile?.resume || "" // ← resume inside profile
//     });
//   })
...
//     console.log("🔍 Sending form data..."); // Debug
